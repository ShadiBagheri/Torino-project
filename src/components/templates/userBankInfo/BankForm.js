...
function BankForm() {
    return(
        <div className="flex flex-col w-full h-[205px] md:h-[220px] lg:w-[950px] lg:h-[185px] py-4 px-5 md:px-10 lg:px-5 border-2 rounded-[10px] bg-[#fff]">
            ...
            <div className="grid grid-cols lg:grid-cols-2 w-full mt-7 md:mt-5 lg:mt-8 lg:px-5 gap-y-5">
