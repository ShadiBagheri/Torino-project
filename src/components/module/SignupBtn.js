...
function SignupBtn({ modalHandler }) {
    return(
        <>
            <button onClick={modalHandler} className="container hidden lg:flex items-center justify-between w-[166px] h-[44px] p-2 border-2 border-solid border-[#28A745] rounded-[8px]">
