...
return(
        <div className="flex w-[180px] h-[120px] sm:w-[200px] sm:h-[140px] md:w-[210px] lg:w-[220px] xl:w-[240px] lg:h-[152px] mt-[160px] sm:mt-[180px] md:mt-52 -ms-12 md:-ms-8 lg:-ms-9 xl:-ms-7 bg-[#fff] border-2 rounded-[11px] z-10 absolute">
            <div className="flex flex-col items-start justify-between">
                <div className="flex w-[178px] h-[38px] sm:w-[198px] sm:h-[40px] md:w-[208px] lg:w-[218px] xl:w-[238px] lg:h-[44px] py-2 px-3 bg-gray-100 rounded-t-[11px]">
                    ...
                    <h2 className="mt-1.5 mr-3 text-xs sm:text-sm lg:text-base font-medium text-[#10411B]">{e2p(mobile)}</h2>
                </div>
                <div className="flex flex-col items-center justify-between">
                    <div className="flex w-[178px] h-[38px] sm:w-[198px] sm:h-[40px] md:w-[208px] md:h-[50px] lg:w-[220px] xl:w-[245px] h-[54px] mt-2 -mb-6 sm:mt-0 sm:mb-1.5 md:mb-0 md:py-2 px-3">
